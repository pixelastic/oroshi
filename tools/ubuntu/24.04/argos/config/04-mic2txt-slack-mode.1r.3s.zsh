...
local iconPath=~/.oroshi/tools/ubuntu/24.04/argos/config/icons/mic2txt-slack-mode-disabled.svg
local slackStatus="off"
if mic2txt-slack-mode-is-enabled; then
  slackStatus="on"
  iconPath=~/.oroshi/tools/ubuntu/24.04/argos/config/icons/mic2txt-slack-mode-enabled.svg
fi
