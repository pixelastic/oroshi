// Bootstrap for the oroshi-modes GNOME Shell extension.
...
export default class OroshiModesExtension extends Extension {
  ...
  //
  // Our reload script (oroshi-modes/reload) write a random token to dist/token,
  // and symlink the main lib/ folder from dist/<token>.
  //
