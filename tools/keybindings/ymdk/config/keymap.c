...
#define LAYER_CONFIG_KEYS \
    ...
    MODE_SPOTIFY, EMPTY_KEY, EMPTY_KEY

#define LAYER_SPOTIFY_KEYS \
    VOLUME_UP, SPOTIFY_PLAY_PAUSE, SPOTIFY_NEXT, \
    VOLUME_DOWN, SPOTIFY_WORK, SPOTIFY_FOCUS, \
    MODE_RP, SPOTIFY_PIANO, SPOTIFY_SLOW_LIVING

#define LAYER_RP_KEYS \
    VOLUME_UP, SPOTIFY_PLAY_PAUSE, SPOTIFY_NEXT, \
    VOLUME_DOWN, RP_GREEN, RP_RED, \
    MODE_CONFIG, RP_YELLOW, RP_PURPLE
