...
PROJECTS[meetups-badges-data:background]="ORANGE_8"
PROJECTS[meetups-badges-data:foreground]="ORANGE_1"
PROJECTS[meetups-badges-data:icon]="󰸍  "
PROJECTS[meetups-badges-data:path]="~/local/www/algolia/meetups-badges-data/"
