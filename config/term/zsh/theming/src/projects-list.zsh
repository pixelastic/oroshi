...
PROJECTS[meetup-calendar:background]="BLUE_9"
PROJECTS[meetup-calendar:foreground]="BLUE_2"
PROJECTS[meetup-calendar:icon]="  "
PROJECTS[meetup-calendar:path]="~/local/www/algolia/meetups-public-calendar/"
PROJECTS[meetup-teasers:background]="GRAY_3"
PROJECTS[meetup-teasers:foreground]="BLUE_8"
PROJECTS[meetup-teasers:icon]=" "
PROJECTS[meetup-teasers:path]="~/local/www/algolia/meetups-teaser-generator/"
