...
# UI
export FZF_DEFAULT_OPTS="${FZF_DEFAULT_OPTS} --color border:$COLOR_RED_5" # Border all around
export FZF_DEFAULT_OPTS="${FZF_DEFAULT_OPTS} --color prompt:$COLOR_WHITE" # > at the start of the input
...
# Current line
export FZF_DEFAULT_OPTS="${FZF_DEFAULT_OPTS} --color pointer:$COLOR_GRAY_8" # > at the start of the current line
