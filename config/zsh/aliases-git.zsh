...
alias vbpsF='git branch-push --force'
alias vbpsfn='git branch-push --force-with-lease --no-verify'
alias vbpsf='git branch-push --force-with-lease'
alias vbpsh='git branch-push-heroku'
alias vbpsn='git branch-push --no-verify'
...
alias vcd='vca -m "chore(deps): Update dependencies"'
