...
# # Text files (orange)
export LS_COLORS="${LS_COLORS}:*.md=38;5;$COLOR[orange5]"
export LS_COLORS="${LS_COLORS}:LICENSE=38;5;$COLOR[orange5]"
export LS_COLORS="${LS_COLORS}:MAINTAINERS=38;5;$COLOR[orange5]"
# # Scripts (purple)
...
export LS_COLORS="${LS_COLORS}:*.js.map=38;5;$COLOR[gray]"
export LS_COLORS="${LS_COLORS}:*.lock=38;5;$COLOR[gray]"
export LS_COLORS="${LS_COLORS}:*.min.css=38;5;$COLOR[gray]"
export LS_COLORS="${LS_COLORS}:*.min.js=38;5;$COLOR[gray]"
export LS_COLORS="${LS_COLORS}:*.part=38;5;$COLOR[gray]"
export LS_COLORS="${LS_COLORS}:.envrc=38;5;$COLOR[gray]"
export LS_COLORS="${LS_COLORS}:_algolia_api_key=38;5;$COLOR[gray]"
