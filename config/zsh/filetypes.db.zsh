...
O_FILETYPES=(
	...
	script      "vim:00;35:ahk,appcache,bat,c,coffee,ctp,css,dat,erb,haml,htm,html,js,json,kml,less,lua,manifest,php,pug,rb,ru,scss,sql,vim,vue,xml,yml,zsh,zsh-theme"
