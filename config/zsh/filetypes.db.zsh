...
O_FILETYPES=(
	...
	executable  "wine:01;31:exe,pyc,so"
	...
	script      "vim:00;35:ahk,appcache,bat,c,ctp,css,dat,erb,htm,html,js,json,kml,less,lua,manifest,php,rb,scss,sh,sql,vim,xml,yml,zsh,zsh-theme"
	...
	txt-full    "writer:01;33:doc,docx,rtf,odt"
