...
PROJECTS[monsters-pages:background]="GRAY_8"
...
PROJECTS[workers.dev:background]="ORANGE"
PROJECTS[workers.dev:foreground]="WHITE"
PROJECTS[workers.dev:icon]="  "
PROJECTS[workers.dev:path]="~/local/www/projects/tim-2bd.workers.dev/"
