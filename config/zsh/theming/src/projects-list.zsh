...
PROJECTS[git-bin,background]="YELLOW"
PROJECTS[git-bin,foreground]="BLACK"
PROJECTS[git-bin,icon]=" "
PROJECTS[git-bin,path]="~/.oroshi/scripts/bin/git/"
PROJECTS[git-function,background]="RED_5"
PROJECTS[git-function,foreground]="WHITE"
PROJECTS[git-function,icon]="{} "
PROJECTS[git-function,path]="~/.oroshi/config/zsh/functions/git/"
