...
PROJECTS[society-pictures:background]="RED_9"
PROJECTS[society-pictures:foreground]="YELLOW_5"
PROJECTS[society-pictures:icon]="  "
PROJECTS[society-pictures:path]="~/local/www/pixelastic.com/gamemaster/society/society-pictures/"
