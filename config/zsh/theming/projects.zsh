...
PROJECTS[earthporn,background]="blue9"
PROJECTS[earthporn,icon]="  "
PROJECTS[earthporn,path]="~/local/www/projects/earthporn/earthporn/"
PROJECTS[earthporn,text]="white"
PROJECTS[earthporn-data,background]="blue8"
PROJECTS[earthporn-data,icon]="  "
PROJECTS[earthporn-data,path]="~/local/www/projects/earthporn/earthporn-data/"
PROJECTS[earthporn-data,text]="white"
