...
# The name of the files follow the headers in Settings > Keyboard Shortcuts
...
# This one is not visible in the UI
source ~/.oroshi/config/ubuntu/22.04/keybindings/custom.zsh
