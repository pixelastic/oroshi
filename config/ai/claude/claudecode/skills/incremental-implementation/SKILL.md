...
3. **Verify** — confirm the slice works as expected (tests pass, lint pass, manual check)
...
- [ ] All existing tests still pass (`yarn run test`)
...
- Tests broken between increments
