...
Target ~100 lines per commit. Changes over ~1000 lines should be split. See the splitting strategies in `code-quality-and-commits` for how to break down large changes.
