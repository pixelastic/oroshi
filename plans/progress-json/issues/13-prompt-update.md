...
Update `tools/term/zsh/config/prompt/git.zsh` function `oroshi-prompt-populate:git_issues_prd` to call `plans-progress` instead of `ralph-progress`. No other logic changes — the output format is identical.
